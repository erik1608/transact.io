...
public class BiometricRequest implements RequestModel {
	private final List<BiometricOperation> sessionRequiredOps = Arrays.asList(BiometricOperation.INIT_REG, BiometricOperation.FINISH_REG, BiometricOperation.DELETE_REG);
