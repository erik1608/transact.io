...
public class PushNotificationService {
	...
	public void sendNotification(String title, String body, HashMap<String, String> message, UserDevice device) {
	...
	private void sendFCMNotification(String title, String body, HashMap<String, String> message, UserDevice device) throws FirebaseMessagingException {
