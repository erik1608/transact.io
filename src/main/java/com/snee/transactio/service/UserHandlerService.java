...
public class UserHandlerService {
    ...
    public final static ExampleMatcher USERNAME_MATCHER = ExampleMatcher
            .matchingAny()
            .withIgnorePaths("id")
            .withMatcher("username", ignoreCase());

    public final static ExampleMatcher EMAIL_MATCHER = ExampleMatcher
            .matchingAny()
            .withIgnorePaths("id", "username")
            .withMatcher("email", ignoreCase());

    private final static ExampleMatcher ACCOUNT_NUMBER_MATCHER = ExampleMatcher
            .matchingAny()
            .withIgnorePaths("id")
            .withMatcher("number", ignoreCase());

    private final static ExampleMatcher DEVICE_MATCHER = ExampleMatcher
            .matchingAny()
            .withIgnorePaths("id")
    ...
    public User registerUser(
        ...
        userPassword
                .setAlgorithm(mPwdHashConfig.getAlgo())
                .setSalt(Base64.getEncoder()
                        .encodeToString(salt))
    ...
    @Transactional
    public UserDevice updateDeviceAndGet(User user, Device device) {
